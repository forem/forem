...
RSpec.describe ClassifiedListingDecorator, type: :decorator do
  ...
  describe "#social_preview_category" do
    xit "returns the category name if the social preview category is blank" do
    ...
    xit "returns the category's social preview descripton if available" do
  ...
  describe "#social_preview_color" do
    xit "returns the default color if social preview color is blank" do
    ...
    xit "returns the category's social preview color if available" do
      expect(decorated_listing.social_preview_color).
        to eq(category.social_preview_color)
    end

    xit "can modify the brightness" do
