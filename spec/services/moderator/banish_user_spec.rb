...
RSpec.describe Moderator::BanishUser, type: :service do
  ...
  xit "updates the user's username" do
  ...
  xit "removes all their articles" do
  ...
  xit "removes all their comments" do
  ...
  xit "creates a BanishedUser record with their original username" do
  ...
  xit "deletes existing vomit reactions on the banished user" do
