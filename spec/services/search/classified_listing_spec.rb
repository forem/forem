...
RSpec.describe Search::ClassifiedListing, type: :service do
  describe "::search_documents", elasticsearch: "ClassifiedListing" do
    ...
    xit "parses classified_listing document hits from search response" do
    ...
    context "with a query" do
      ...
      xit "searches by classified_listing_search" do
    ...
    context "with a term filter" do
      ...
      xit "searches by contact_via_connect" do
    ...
    xit "sorts documents for a given field" do
    ...
    xit "sorts documents by bumped_at by default" do
