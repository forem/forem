...
RSpec.describe Search::QueryBuilders::FeedContent, type: :service do
  describe "::intialize" do
    ...
    xit "builds query body with html encoder" do
      filter = described_class.new(params: {})
      expect(filter.body).to include("highlight" => hash_including("encoder" => "html"))
    end

    xit "sets published to true" do
      filter = described_class.new(params: {})
  ...
  describe "#as_hash" do
    ...
    xit "applies RANGE_KEYS from params" do
    ...
    xit "applies QUERY_KEYS, TERM_KEYS, and RANGE_KEYS from params" do
      Timecop.freeze(Time.current) do
    ...
    xit "correctly sets default sort" do
