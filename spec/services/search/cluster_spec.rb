...
RSpec.describe Search::Cluster, type: :service do
  describe "::recreate_indexes" do
    xit "destroys and sets up indexes" do
  ...
  describe "::setup_indexes" do
    xit "creates, adds aliases and updates mappings for indexes" do
  ...
  describe "::create_indexes" do
    xit "calls create_index for each search class" do
  ...
  describe "::delete_indexes" do
    xit "calls delete_index for each search class" do
  ...
  describe "::add_aliases" do
    xit "calls add_alias for each search class" do
      described_class::SEARCH_CLASSES.each do |search_class|
  ...
  describe "::update_mappings" do
    xit "calls update_mappings for each search class" do
      described_class::SEARCH_CLASSES.each do |search_class|
  ...
  describe "::update_settings" do
    xit "updates cluster settings" do
