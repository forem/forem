...
RSpec.describe Reactions::BustHomepageCacheWorker, type: :worker do
  describe "#perform" do
    ...
    xit "busts the homepage cache when reactable is an Article" do
    ...
    xit "doesn't bust the homepage cache when reactable is a Comment" do
    ...
    xit "doesn't fail if a reaction doesn't exist" do
      expect do
