...
RSpec.describe ArticleSuggester, type: :labor do
  ...
  xit "returns proper number of articles with post with the same tags" do
  ...
  xit "returns proper number of articles with post with different tags" do
  ...
  xit "returns proper number of articles with post without tags" do
  ...
  xit "returns the number of articles requested" do
