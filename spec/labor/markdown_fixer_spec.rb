...
RSpec.describe MarkdownFixer, type: :labor do
  ...
  describe "::add_quotes_to_title" do
    ...
    xit "does not escape a title that came pre-wrapped in single quotes" do
    ...
    xit "does not escape a title that came pre-wrapped in double quotes" do
      legacy_title = "\"#{sample_text}\""
      result = described_class.add_quotes_to_title(front_matter(title: legacy_title))
      expect(result).to eq(front_matter(title: legacy_title))
    end

    xit "handles a complex title" do
    ...
    xit "handles a title with colons" do
  ...
  describe "::add_quotes_to_description" do
    ...
    xit "escapes a simple description" do
    ...
    xit "does not escape a description that came pre-wrapped in single quotes" do
    ...
    xit "does not escape a description that came pre-wrapped in double quotes" do
      legacy_description = "\"#{sample_text}\""
      result = described_class.
        add_quotes_to_description(front_matter(description: legacy_description))
      expect(result).to eq(front_matter(description: legacy_description))
    ...
    xit "handles a complex description" do
    ...
    xit "handles a description with colons" do
  ...
  describe "::fix_all" do
    xit "escapes title and description" do
      result = described_class.
  ...
  describe "::underscores_in_usernames" do
    xit "escapes underscores in a username" do
      test_string1 = "@_xy_"
    ...
    xit "does not escape underscores when it is not a username" do
    ...
    xit "escapes correctly and ignores underscored username in code and code block" do
      input = <<~INPUT
        @_dev_
