...
RSpec.describe RateLimitChecker do
  ...
  it ".limit_by_action returns false for invalid case" do
    expect(described_class.new(user).limit_by_action("random-nothing")).to eq(false)
  end

  it ".limit_by_action returns true if too many comments at once" do
  ...
  it ".limit_by_action returns false if allowed comment" do
  ...
  it ". limit_by_action returns true if too many published articles at once" do
  ...
  it ".limit_by_action returns false if published articles comment" do
