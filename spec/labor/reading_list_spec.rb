...
RSpec.describe ReadingList, type: :labor do
  ...
  xit "returns count of articles if they've been reacted to" do
  ...
  xit "returns an article if it's been reacted to" do
    create_reaction(user, article)
    create_reaction(user, article2)
  ...
  xit "returns cached ids of articles that have been reacted to" do
    create_reaction(user, article)
    create_reaction(user, article2)
  ...
  xit "returns an empty count if no reacted article" do
