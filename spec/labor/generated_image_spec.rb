...
RSpec.describe GeneratedImage, type: :labor do
  ...
  xit "returns the social image url if there is a social image" do
    article.social_image = Faker::Avatar.image
    expect(described_class.new(article).social_image).to eq(article.social_image)
  end

  xit "returns the main image if there is a main image" do
  ...
  xit "returns article social image" do
  ...
  xit "creates various generated images of different title lengths" do
