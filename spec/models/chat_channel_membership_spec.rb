...
RSpec.describe ChatChannelMembership, type: :model do
  ...
  describe "#channel_text" do
    xit "sets channel text using name, slug, and human names" do
  ...
  describe "#after_commit" do
    xit "on update enqueues job to index chat_channel_membership to elasticsearch" do
    ...
    xit "on destroy enqueues job to delete chat_channel_membership from elasticsearch" do
      chat_channel_membership.save
