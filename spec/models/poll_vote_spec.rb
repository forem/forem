...
RSpec.describe PollVote, type: :model do
  ...
  xit "is not valid as a new object" do
    expect(described_class.new.valid?).to be(false)
  end

  xit "limits one vote per user per poll" do
  ...
  xit "allows one vote per user across multiple polls" do
  ...
  xit "allows multiple people to vote in one poll" do
