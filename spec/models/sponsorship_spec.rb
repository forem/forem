...
RSpec.describe Sponsorship, type: :model do
  ...
  describe "constants" do
    xit "has the correct values for constants" do
  ...
  describe "#url" do
    ...
    xit "accepts a blank url" do
      sponsorship.url = ""
      expect(sponsorship).to be_valid
    end

    xit "accepts a HTTP url" do
      sponsorship.url = "http://example.com"
      expect(sponsorship).to be_valid
    end

    xit "accepts a HTTPS url" do
  ...
  describe "validations" do
    ...
    xit "forbids an org to have multiple 'expiring' (bronze-silver-gold) sponsorships" do
    ...
    xit "allows to create a new sponsorship for the same org if the previous one is expired" do
    ...
    xit "allows to create a new sponsorship for the same level for another org" do
      create(:sponsorship, level: :gold, organization: org, expires_at: 2.days.from_now)
    ...
    context "when tag sponsorships" do
      ...
      xit "allows an org to have multiple tag sponsorships on different tags" do
      ...
      xit "allows to create a new tag sponsorship if the previous one is expired" do
      ...
      xit "forbids an org to have multiple active tag sponsorships on the same tag" do
      ...
      xit "forbids different orgs to have active sponsorships on the same tag" do
        other_org = create(:organization)
