...
RSpec.describe Credit, type: :model do
  ...
  describe "#purchase" do
    ...
    xit "is valid with a purchase" do
      credit.purchase = build(:classified_listing)
      expect(credit).to be_valid
    end

    xit "is valid without a purchase" do
      credit.purchase = nil
      expect(credit).to be_valid
    end
  end
