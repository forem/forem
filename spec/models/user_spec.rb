...
RSpec.describe User do
  ...
  describe "theming properties" do
    ...
    it "creates proper body class with defaults" do
      ...
      classes = "light-theme sans-serif-article-body #{user.setting.config_navbar}-header"
    ...
    it "creates proper body class with open dyslexic config" do
      ...
      # rubocop:disable Layout/LineLength
      classes = "light-theme open-dyslexic-article-body #{user.setting.config_navbar}-header"
      # rubocop:enable Layout/LineLength
      expect(user.decorate.config_body_class).to eq(classes)
    end
    ...
    it "creates proper body class with dark theme" do
      ...
      classes =
        "dark-theme sans-serif-article-body #{user.setting.config_navbar}-header"
      expect(user.decorate.config_body_class).to eq(classes)
    end
  end
