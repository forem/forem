...
RSpec.describe User, type: :model do
  ...
  describe "validations" do
    describe "builtin validations" do
      ...
      xit "has at most three optional fields" do
    ...
    xit "validates username against reserved words" do
    ...
    xit "validates can_send_confirmation_email for existing user" do
      user = create(:user)
    ...
    xit "validates update_rate_limit for existing user" do
      user = create(:user)
      limiter = RateLimitChecker.new(user)
      allow(user).to receive(:rate_limiter).and_return(limiter)
      allow(limiter).to receive(:limit_by_action).and_return(true)
  ...
  describe "#after_commit" do
    xit "on update enqueues job to index user to elasticsearch" do
      user.save
    ...
    xit "on destroy enqueues job to delete user from elasticsearch" do
      user.save
  ...
  context "when callbacks are triggered before validation" do
    ...
    describe "#twitter_username" do
      xit "sets twitter username to nil if empty" do
        user.twitter_username = ""
        user.validate!
        expect(user.twitter_username).to eq(nil)
      end

      xit "does not change a valid name" do
    ...
    describe "#github_username" do
      xit "sets github username to nil if empty" do
    ...
    describe "#email" do
      xit "sets email to nil if empty" do
        user.email = ""
        user.validate!
    ...
    describe "#username" do
      xit "receives a temporary username if none is given" do
        user.username = ""
        user.validate!
        expect(user.username).not_to be_blank
      end

      xit "does not allow to change to a username that is taken" do
        user.username = other_user.username
        expect(user).not_to be_valid
      end

      xit "does not allow to change to a username that is taken by an organization" do
    ...
    describe "#website_url" do
      xit "does not accept invalid website url" do
        user.website_url = "ben.com"
        expect(user).not_to be_valid
      end

      xit "accepts valid http website url" do
    ...
    describe "#mastodon_url" do
      xit "accepts valid https mastodon url" do
        user.mastodon_url = "https://mastodon.social/@test"
        expect(user).to be_valid
      end

      xit "does not accept a denied mastodon instance" do
        user.mastodon_url = "https://SpammyMcSpamface.com/"
        expect(user).not_to be_valid
      end

      xit "does not accept invalid mastodon url" do
        user.mastodon_url = "mastodon.social/@test"
        expect(user).not_to be_valid
      end

      xit "does not accept an invalid url" do
    ...
    describe "#facebook_url" do
      xit "accepts valid https facebook url", :aggregate_failures do
      ...
      xit "does not accept invalid facebook url" do
    ...
    describe "#youtube_url" do
      xit "accepts valid https youtube url", :aggregate_failures do
        %w[thepracticaldev thepracticaldev/ the.practical.dev].each do |username|
      ...
      xit "does not accept invalid youtube url" do
    ...
    describe "#behance_url" do
      xit "accepts valid https behance url", :aggregate_failures do
      ...
      xit "does not accept invalid behance url" do
    ...
    describe "#twitch_url" do
      xit "does not accept invalid twitch url" do
        user.twitch_url = "ben.com"
        expect(user).not_to be_valid
      end

      xit "accepts valid https twitch url", :aggregate_failures do
    ...
    describe "#stackoverflow_url" do
      xit "accepts valid https stackoverflow url", :aggregate_failures do
      ...
      xit "does not accept invalid stackoverflow url" do
        user.stackoverflow_url = "ben.com"
        expect(user).not_to be_valid
      end

      xit "accepts valid stackoverflow sub community url", :aggregate_failures do
      ...
      xit "does not accept invalid stackoverflow sub community url" do
    ...
    describe "#linkedin_url" do
      xit "accepts valid https linkedin url", :aggregate_failures do
      ...
      xit "accepts valid country specific https linkedin url" do
        user.linkedin_url = "https://mx.linkedin.com/in/jessleenyc"
        expect(user).to be_valid
      end

      xit "does not accept three letters country codes in http linkedin url" do
        user.linkedin_url = "http://mex.linkedin.com/in/jessleenyc"
        expect(user).not_to be_valid
      end

      xit "does not accept three letters country codes in https linkedin url" do
        user.linkedin_url = "https://mex.linkedin.com/in/jessleenyc"
        expect(user).not_to be_valid
      end

      xit "does not accept invalid linkedin url" do
    ...
    describe "#dribbble_url", :aggregate_failures do
      xit "accepts valid https dribbble url" do
      ...
      xit "does not accept invalid dribbble url" do
    ...
    describe "#medium_url" do
      xit "accepts valid https medium url", :aggregate_failures do
        %w[jess jess/ je-ss je_ss].each do |username|
      ...
      xit "does not accept invalid medium url" do
    ...
    describe "#instagram_url" do
      xit "does not accept invalid instagram url" do
        user.instagram_url = "ben.com"
        expect(user).not_to be_valid
      end

      xit "accepts valid instagram url", :aggregate_failures do
    ...
    describe "#gitlab_url" do
      xit "accepts valid https gitlab url", :aggregate_failures do
        %w[jess jess/ je-ss je_ss].each do |username|
      ...
      xit "does not accept invalid gitlab url" do
    ...
    describe "#employer_url" do
      xit "does not accept invalid employer url" do
        user.employer_url = "ben.com"
        expect(user).not_to be_valid
      end

      xit "does accept valid http employer url" do
        user.employer_url = "http://ben.com"
        expect(user).to be_valid
      end

      xit "does accept valid https employer url" do
    ...
    describe "#config_theme" do
      xit "accepts valid theme" do
        user.config_theme = "night theme"
        expect(user).to be_valid
      end

      xit "does not accept invalid theme" do
    ...
    describe "#config_font" do
      xit "accepts valid font" do
        user.config_font = "sans serif"
        expect(user).to be_valid
      end

      xit "does not accept invalid font" do
    ...
    describe "#config_navbar" do
      xit "accepts valid navbar" do
        user.config_navbar = "static"
        expect(user).to be_valid
      end

      xit "does not accept invalid navbar" do
    ...
    context "when the past value is relevant" do
      ...
      xit "changes old_username and old_old_username properly if username changes" do
      ...
      xit "enforces summary length validation if previous summary was valid" do
        user.summary = "0" * 999
      ...
      xit "does not enforce summary validation if previous summary was invalid" do
  ...
  context "when callbacks are triggered before and after create" do
    ...
    describe "#language_settings" do
      xit "sets correct language_settings by default" do
        expect(user.language_settings).to eq("preferred_languages" => %w[en])
      end

      xit "sets correct language_settings by default after the jobs are processed" do
    ...
    describe "#estimated_default_language" do
      xit "estimates default language to be nil" do
        sidekiq_perform_enqueued_jobs do
          expect(user.estimated_default_language).to be(nil)
        end
      end

      xit "estimates default language to be japanese with .jp email" do
        user = nil
      ...
      xit "estimates default language based on ID dump" do
        new_user = nil
    ...
    describe "#send_welcome_notification" do
      ...
      xit "sends a setup welcome notification when an active broadcast exists" do
        new_user = nil
        sidekiq_perform_enqueued_jobs do
      ...
      xit "does not send a setup welcome notification without an active broadcast" do
    ...
    describe "#preferred_languages_array" do
      xit "returns proper preferred_languages_array" do
        user = nil
      ...
      xit "returns a correct array when language settings are in a new format" do
      ...
      xit "returns a correct array when language settings are in the old format" do
        language_settings = {
  ...
  context "when callbacks are triggered after save" do
    ...
    describe "#conditionally_resave_articles" do
      ...
      xit "enqueues resave articles job when changing username" do
      ...
      xit "enqueues resave articles job when changing name" do
        sidekiq_assert_enqueued_with(
          job: Users::ResaveArticlesWorker,
          args: [user.id],
          queue: "medium_priority",
      ...
      xit "enqueues resave articles job when changing summary" do
        sidekiq_assert_enqueued_with(
          job: Users::ResaveArticlesWorker,
          args: [user.id],
          queue: "medium_priority",
      ...
      xit "enqueues resave articles job when changing bg_color_hex" do
        sidekiq_assert_enqueued_with(
          job: Users::ResaveArticlesWorker,
          args: [user.id],
          queue: "medium_priority",
      ...
      xit "enqueues resave articles job when changing text_color_hex" do
        sidekiq_assert_enqueued_with(
          job: Users::ResaveArticlesWorker,
          args: [user.id],
          queue: "medium_priority",
      ...
      xit "enqueues resave articles job when changing profile_image" do
        sidekiq_assert_enqueued_with(
          job: Users::ResaveArticlesWorker,
          args: [user.id],
          queue: "medium_priority",
      ...
      xit "enqueues resave articles job when changing github_username" do
        sidekiq_assert_enqueued_with(
          job: Users::ResaveArticlesWorker,
          args: [user.id],
          queue: "medium_priority",
      ...
      xit "enqueues resave articles job when changing twitter_username" do
        sidekiq_assert_enqueued_with(
          job: Users::ResaveArticlesWorker,
          args: [user.id],
          queue: "medium_priority",
      ...
      xit "doesn't enqueue resave articles when changing resave attributes but user is banned" do
  ...
  describe "user registration" do
    ...
    xit "finds user by email and assigns identity to that if exists" do
    ...
    xit "assigns random username if username is taken on registration" do
    ...
    xit "assigns random username if username is taken by organization on registration" do
    ...
    xit "assigns signup_cta_variant to state param with Twitter if new user" do
      new_user = user_from_authorization_service(:twitter, nil, "hey-hey-hey")
      expect(new_user.signup_cta_variant).to eq("hey-hey-hey")
    end

    xit "does not assign signup_cta_variant to non-new users" do
    ...
    xit "persists JSON dump of identity data" do
      new_user = user_from_authorization_service(:twitter, nil, "navbar_basic")
      identity = new_user.identities.first
      expect(identity.auth_data_dump.provider).to eq(identity.provider)
    end

    xit "persists extracts relevant identity data from new twitter user" do
      new_user = user_from_authorization_service(:twitter, nil, "navbar_basic")
    ...
    xit "persists extracts relevant identity data from new github user" do
      new_user = user_from_authorization_service(:github, nil, "navbar_basic")
      expect(new_user.github_created_at).to be_kind_of(ActiveSupport::TimeWithZone)
    end

    xit "does not allow previously banished users to sign up again" do
    ...
    xit "does not allow an existing user to change their name to a banished one" do
      banished_name = "SpammyMcSpamface"
      create(:banished_user, username: banished_name)
      user = create(:user)
  ...
  describe "#moderator_for_tags" do
    ...
    xit "lists tags user moderates" do
    ...
    xit "returns empty array if no tags moderated" do
  ...
  describe "theming properties" do
    ...
    xit "determines dark theme if night theme" do
      user.config_theme = "night_theme"
      expect(user.decorate.dark_theme?).to eq(true)
    end

    xit "determines dark theme if ten x hacker" do
      user.config_theme = "ten_x_hacker_theme"
      expect(user.decorate.dark_theme?).to eq(true)
    end

    xit "determines not dark theme if not one of the dark themes" do
      user.config_theme = "default"
      expect(user.decorate.dark_theme?).to eq(false)
    end

    xit "creates proper body class with sans serif config" do
    ...
    xit "creates proper body class with open dyslexic config" do
    ...
    xit "creates proper body class with night theme" do
      user.config_theme = "night_theme"
    ...
    xit "creates proper body class with pink theme" do
  ...
  describe "cache counts" do
    xit "has an accurate tag follow count" do
      tag = create(:tag)
      user.follow(tag)
      expect(user.reload.following_tags_count).to eq(1)
    end

    xit "has an accurate user follow count" do
      user.follow(other_user)
      expect(user.reload.following_users_count).to eq(1)
    end

    xit "has an accurate organization follow count" do
      user.follow(org)
  ...
  describe "#org_admin?" do
    xit "recognizes an org admin" do
      create(:organization_membership, user: user, organization: org, type_of_user: "admin")
      expect(user.org_admin?(org)).to be(true)
    end

    xit "forbids an incorrect org admin" do
    ...
    xit "returns false if nil is given" do
      expect(user.org_admin?(nil)).to be(false)
    end
  end

  describe "#pro?" do
    xit "returns false if the user is not a pro" do
      expect(user.pro?).to be(false)
    end

    xit "returns true if the user has the pro role" do
      user.add_role(:pro)
  ...
  describe "#receives_follower_email_notifications?" do
    xit "returns false if user has no email" do
      user.assign_attributes(email: nil)
      expect(user.receives_follower_email_notifications?).to be(false)
    end

    xit "returns false if user opted out from follower notifications" do
      user.assign_attributes(email_follower_notifications: false)
      expect(user.receives_follower_email_notifications?).to be(false)
    end

    xit "returns true if user opted in from follower notifications and has an email" do
  ...
  describe ".dev_account" do
    xit "returns nil if the account does not exist" do
      expect(described_class.dev_account).to be_nil
    end

    xit "returns the user if the account exists" do
  ...
  describe "#authenticated_through?" do
    ...
    xit "returns false if provider is not known" do
      expect(user.authenticated_through?(:unknown)).to be(false)
    end

    xit "returns false if provider is not enabled" do
    ...
    xit "returns false if the user has no related identity" do
      expect(user.authenticated_through?(provider)).to be(false)
    end

    xit "returns true if the user has related identity" do
