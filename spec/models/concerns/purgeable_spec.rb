...
RSpec.describe Purgeable do
  ...
  describe "class methods" do
    xit "calls .purge_by_key with table_key in purge_all" do
    ...
    xit "returns a Fastly::Service object" do
      model_class.service
  ...
  describe "instance methods" do
    xit "returns a record key" do
      expect(purgeable_model.record_key).to eq("purgeables/1")
    end

    xit "returns a table_key" do
