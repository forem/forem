...
RSpec.describe Notifications::RemoveAllByActionJob, type: :job do
  ...
  describe "#perform_now" do
    ...
    it "calls the service" do
      described_class.perform_now(article, "Published", remove_all_by_action_service)
      expect(remove_all_by_action_service).to have_received(:call).with(article, "Published")
    end
  end
end
