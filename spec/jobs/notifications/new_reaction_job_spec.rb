...
RSpec.describe Notifications::NewReactionJob, type: :job do
  ...
  include_examples "#enqueues_job", "send_new_reaction_notification", [{}, {}]
  ...
  describe "#perform_now" do
    ...
    it "calls the service" do
      described_class.perform_now(reaction_data, receiver_data)
    ...
    it "doesn't call if is a receiver is of a wrong class" do
      described_class.perform_now(reaction_data, { klass: "Tag", id: 10 })
      expect(reaction_service).not_to have_received(:call)
    end

    it "doesn't call if is a receiver doesn't exist" do
      described_class.perform_now(reaction_data, { klass: "Organization", id: nil })
      expect(reaction_service).not_to have_received(:call)
    end
  end
end
