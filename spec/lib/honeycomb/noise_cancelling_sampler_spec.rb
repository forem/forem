...
RSpec.describe Honeycomb::NoiseCancellingSampler do
  ...
  context "with a redis command" do
    xit "samples if its a NOISY_COMMANDS" do
    ...
    xit "samples if the command is BRPOP" do
