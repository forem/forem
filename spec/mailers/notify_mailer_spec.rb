...
RSpec.describe NotifyMailer, type: :mailer do
  ...
  describe "#new_badge_email" do
    ...
    context "when rendering the HTML email" do
      ...
      it "includes the listings URL" do
        expect(email.html_part.body).to include(
          CGI.escape(
            Rails.application.routes.url_helpers.listings_url.gsub(ENV["APP_DOMAIN"], SiteConfig.app_domain),
          ),
        )
      end
      ...
      it "includes the about listings URL" do
        expect(email.html_part.body).to include(
          CGI.escape(Rails.application.routes.url_helpers.about_listings_url).gsub(ENV["APP_DOMAIN"], SiteConfig.app_domain),
        )
      end
    ...
    context "when rendering the text email" do
      ...
      it "includes the about listings URL" do
        expect(email.text_part.body).to include(Rails.application.routes.url_helpers.about_listings_url.gsub(ENV["APP_DOMAIN"], SiteConfig.app_domain))
      end
