...
RSpec.describe "/admin/customiation/profile_fields", type: :request do
  ...
  describe "GET /admin/customiation/profile_fields" do
  ...
  describe "POST /admin/customiation/profile_fields" do
