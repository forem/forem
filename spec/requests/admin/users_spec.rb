...
RSpec.describe "/admin/member_management/users", type: :request do
  let!(:user) do
  ...
  describe "GET /admin/member_management/users" do
  ...
  describe "GET /admin/member_management/users/:id" do
    it "renders to appropriate page" do
  ...
  describe "POST /admin/member_management/users/:id/banish" do
  ...
  describe "POST /admin/member_management/users/:id/send_email" do
    let(:params) do
      {
        email_body: "Body",
  ...
  describe "POST /admin/member_management/users/:id/verify_email_ownership" do
    let(:mailer) { double }
    let(:message_delivery) { double }
  ...
  describe "POST /admin/member_management/users/:id/unpublish_all_articles" do
  ...
  describe "DELETE /admin/member_management/users/:id/remove_identity" do
  ...
  describe "POST /admin/member_management/users/:id/export_data" do
