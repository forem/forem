    ...
    context "when admin has full permissions including super" do
      ...
      describe "Images" do
        ...
        it "updates logo_png" do
          expected_default_image_url = SiteConfig.get_field(:logo_png).dig(:default)
          expected_image_url = "https://dummyimage.com/300x300.png"
          expect do
      ...
      describe "Mascot" do
        ...
        it "updates mascot_image_url" do
          expected_default_image_url = SiteConfig.get_field(:mascot_image_url).dig(:default)
          expected_image_url = "https://dummyimage.com/300x300.png"
          expect do
        ...
        it "updates the mascot_footer_image_width" do
          expected_default_mascot_footer_image_width = SiteConfig.get_field(:mascot_footer_image_width).dig(:default)
        ...
        it "updates the mascot_footer_image_height" do
          expected_default_mascot_footer_image_height = SiteConfig.get_field(:mascot_footer_image_height).dig(:default)
      ...
      describe "Rate Limits and spam" do
        it "updates rate_limit_follow_count_daily" do
          default_value = SiteConfig.get_field(:rate_limit_follow_count_daily).dig(:default)
          expect do
        ...
        it "updates rate_limit_comment_creation" do
          default_value = SiteConfig.get_field(:rate_limit_comment_creation).dig(:default)
          expect do
        ...
        it "updates rate_limit_published_article_creation" do
          default_value = SiteConfig.get_field(:rate_limit_published_article_creation).dig(:default)
          expect do
        ...
        it "updates rate_limit_published_article_antispam_creation" do
          default_value = SiteConfig.get_field(:rate_limit_published_article_antispam_creation).dig(:default)
          expect do
        ...
        it "updates rate_limit_organization_creation" do
          default_value = SiteConfig.get_field(:rate_limit_organization_creation).dig(:default)
          expect do
        ...
        it "updates rate_limit_image_upload" do
          default_value = SiteConfig.get_field(:rate_limit_image_upload).dig(:default)
          expect do
        ...
        it "updates rate_limit_email_recipient" do
          default_value = SiteConfig.get_field(:rate_limit_email_recipient).dig(:default)
          expect do
        ...
        it "updates rate_limit_user_subscription_creation" do
          default_value = SiteConfig.get_field(:rate_limit_user_subscription_creation).dig(:default)
          expect do
        ...
        it "updates rate_limit_article_update" do
          default_value = SiteConfig.get_field(:rate_limit_article_update).dig(:default)
          expect do
        ...
        it "updates rate_limit_listing_creation" do
          default_value = SiteConfig.get_field(:rate_limit_listing_creation).dig(:default)
          expect do
        ...
        it "updates rate_limit_reaction_creation" do
          default_value = SiteConfig.get_field(:rate_limit_reaction_creation).dig(:default)
          expect do
        ...
        it "updates rate_limit_send_email_confirmation" do
          default_value = SiteConfig.get_field(:rate_limit_send_email_confirmation).dig(:default)
          expect do
      ...
      describe "Credits" do
        it "updates the credit prices", :aggregate_failures do
          original_prices = SiteConfig.get_field(:credit_prices_in_cents).dig(:default)
