...
RSpec.describe "ArticlesDestroy", type: :request do
  ...
  xit "removes all previous published notifications" do
  ...
  xit "doesn't destroy another person's article" do
