...
RSpec.describe "Pages", type: :request do
  describe "GET /:slug" do
    xit "has proper headline for non-top-level" do
    ...
    xit "has proper headline for top-level" do
  ...
  describe "GET /api" do
    xit "redirects to the API docs" do
      get "/api"
  ...
  describe "GET /welcome" do
    xit "redirects to the latest welcome thread" do
  ...
  describe "GET /challenge" do
    xit "redirects to the latest challenge thread" do
      user = create(:user, id: 1)
  ...
  describe "GET /checkin" do
    ...
    xit "redirects to the latest CodeNewbie staff thread" do
    ...
    xit "redirects to /notifications if there is no staff user post" do
      get "/checkin"
  ...
  describe "GET /report-abuse" do
    context "when provided the referer" do
      xit "prefills with the provided url" do
        url = Faker::Internet.url
        get "/report-abuse", headers: { referer: url }
        expect(response.body).to include(url)
      end

      xit "does not prefill if the provide url is /serviceworker.js" do
    ...
    context "when provided the params" do
      xit "prefills with the provided param url" do
        url = "https://dev.to/serviceworker.js"
