...
RSpec.describe "Onboardings", type: :request do
  ...
  describe "GET /onboarding" do
    ...
    it "contains proper data attribute values if the onboarding config is present" do
      allow(Settings::General).to receive(:secondary_logo_url).and_return("whatevs.png")
      ...
      expect(response.body).to include(safe_logo_url(Settings::General.secondary_logo_url))
