...
RSpec.describe "Api::V1::Docs::Articles" do
  ...
  describe "GET /organizations/{username}" do
    before do
      ...
      create(:listing, organization: organization)
...
It supports pagination, each page will contain `30` users by default."
    ...
    path "/api/organizations/{username}/listings" do
      get "Organization's listings" do
...
It supports pagination, each page will contain `30` users by default."
        ...
        response "200", "An Organization's listings" do
          let(:username) { organization.username }
          schema  type: :array,
