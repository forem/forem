...
RSpec.describe "Api::V0::Instances", type: :request do
  describe "GET /api/instance" do
    it "returns the correct attributes", :aggregate_failures do
      ...
      expect(response.parsed_body["context"]).to eq ApplicationConfig["FOREM_CONTEXT"].to_s
      ...
      expect(response.parsed_body["tagline"]).to eq Settings::Community.tagline.to_s
