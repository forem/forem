...
RSpec.describe "Api::V0::Admin::Configs", type: :request do
  ...
  describe "POST /api/admin/config" do
    context "when user is super admin" do
      ...
      it "Modifies SiteConfig data" do
        post api_admin_config_path, params: { site_config: { community_name: "new" } }.to_json, headers: headers
      ...
      it "enables proper domains to allow list" do
        ...
        post api_admin_config_path, params: { site_config: { allowed_registration_email_domains: proper_list } }.to_json,
          headers: headers
      ...
      it "does not allow improper domain list" do
        ...
        post api_admin_config_path, params: { site_config: { allowed_registration_email_domains: improper_list } }.to_json,
          headers: headers
      ...
      it "removes space suggested_tags" do
        post api_admin_config_path, params: { site_config: { suggested_tags: "hey, haha,hoho, bobo fofo" } }.to_json,
          headers: headers
      ...
      it "Renders siteconfig result" do
        post api_admin_config_path, params: { site_config: { community_name: "new" } }.to_json,
          headers: headers
