...
RSpec.describe "AdditionalContentBoxes", type: :request do
  ...
  describe "GET /additional_content_boxes" do
    xit "returns an article if there is a published/featured one" do
    ...
    xit "returns no article if not published/featured" do
    ...
    xit "returns boosted article if available" do
    ...
    xit "returns 422 status if article_id is missing" do
