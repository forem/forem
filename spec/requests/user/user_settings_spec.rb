  ...
  describe "GET /settings/:tab" do
    ...
    context "when signed-in" do
      ...
      it "displays content on Extensions tab properly" do
        ...
        feed_section = "Publishing to #{Settings::General.community_name} from RSS"
        stackbit_section = "Generate a personal blog from your #{Settings::General.community_name} posts"
