...
RSpec.describe "ApiSecretsDestroy", type: :request do
  ...
  describe "DELETE /users/api_secrets" do
    ...
    context "when delete fails" do
      ...
      xit "does not delete the ApiSecret" do
