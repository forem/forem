...
RSpec.describe "/internal/config", type: :request do
  ...
  describe "POST internal/events as a user" do
    ...
    xit "bars the regular user to access" do
  ...
  describe "POST internal/events" do
    context "when admin has typical admin permissions but not single resource" do
      ...
      xit "does not allow user to update config if they have proper confirmation" do
      ...
      xit "does not allow user to update config if they do not have proper confirmation" do
        expected_image_url = "https://dummyimage.com/300x300"
    ...
    context "when admin has full permissions including single resource" do
      ...
      describe "community content" do
        xit "updates the community_description" do
        ...
        xit "updates the community_member_description" do
          description = "Hey hey #{rand(100)}"
        ...
        xit "updates the community_member_label" do
          name = "developer"
      ...
      describe "mascot" do
        xit "updates the mascot_user_id" do
        ...
        xit "updates mascot_image_url" do
          expected_image_url = "https://dummyimage.com/300x300"
        ...
        xit "updates mascot_image_description" do
          description = "Hey hey #{rand(100)}"
      ...
      describe "social media" do
        xit "does not allow the staff_user_id to be updated" do
        ...
        xit "updates social_media_handles" do
      ...
      describe "emails" do
        xit "updates email_addresses" do
      ...
      describe "onboarding" do
        xit "updates onboarding_taskcard_image" do
          expected_image_url = "https://dummyimage.com/300x300"
        ...
        xit "removes space suggested_tags" do
        ...
        xit "downcases suggested_tags" do
          post "/internal/config", params: { site_config: { suggested_tags: "hey, haha,hoHo, Bobo Fofo" }, confirmation: confirmation_message }
          expect(SiteConfig.suggested_tags).to eq(%w[hey haha hoho bobofofo])
        end

        xit "removes space suggested_users" do
        ...
        xit "downcases suggested_users" do
          post "/internal/config", params: { site_config: { suggested_users: "piglet, tigger,EEYORE, Christopher Robin, KANGA,RoO" }, confirmation: confirmation_message }
          expect(SiteConfig.suggested_users).to eq(%w[piglet tigger eeyore christopherrobin kanga roo])
        end
      end
      ...
      describe "images" do
        xit "updates main_social_image" do
          expected_image_url = "https://dummyimage.com/300x300"
        ...
        xit "updates primary_sticker_image_url" do
          expected_image_url = "https://dummyimage.com/300x300"
        ...
        xit "rejects update without proper confirmation" do
          expected_image_url = "https://dummyimage.com/300x300"
      ...
      describe "monetization" do
        xit "updates payment pointer" do
      ...
      describe "rate limits" do
        xit "updates rate_limit_follow_count_daily" do
          expect do
        ...
        xit "updates rate_limit_comment_creation" do
          expect do
        ...
        xit "updates rate_limit_published_article_creation" do
          expect do
        ...
        xit "updates rate_limit_organization_creation" do
          expect do
        ...
        xit "updates rate_limit_image_upload" do
          expect do
        ...
        xit "updates rate_limit_email_recipient" do
          expect do
      ...
      describe "Mailchimp lists IDs" do
        xit "updates mailchimp_newsletter_id" do
        ...
        xit "updates mailchimp_sustaining_members_id" do
        ...
        xit "updates mailchimp_tag_moderators_id" do
        ...
        xit "updates mailchimp_community_moderators_id" do
      ...
      describe "Email digest frequency" do
        xit "updates periodic_email_digest_max" do
        ...
        xit "updates periodic_email_digest_min" do
      ...
      describe "Tags" do
        xit "removes space sidebar_tags" do
      ...
      describe "Shop" do
        xit "rejects update to shop_url without proper confirmation" do
      ...
      describe "Authentication" do
        xit "updates enabled authentication providers" do
