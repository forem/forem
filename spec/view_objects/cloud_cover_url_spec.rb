...
RSpec.describe CloudCoverUrl, cloudinary: true, type: :view_object do
  ...
  it "returns proper url" do
    expect(described_class.new(article.main_image).call)
      ...
      .and include("/c_crop,f_auto,fl_progressive,h_420,q_auto,w_1000/https://robohash.org/")
  end
  ...
  it "returns proper url when nested cloudinary" do
    ...
    cloudinary_string = "/c_crop,f_auto,fl_progressive,h_420,q_auto,w_1000/https://dev-to-uploads.s3.amazonaws.com/i/th93d625o27nuz63oeen.png" # rubocop:disable Layout/LineLength
