...
RSpec.describe BlackBox, type: :black_box do
  ...
  describe "#article_hotness_score" do
    ...
    xit "doesn't fail when function caller returns nil" do
  ...
  describe "#comment_quality_score" do
    xit "returns the correct score" do
  ...
  describe "#calculate_spaminess" do
    ...
    xit "returns 100 if there is no user" do
    ...
    xit "calls the function_caller" do
    ...
    xit "returns the value that the caller returns" do
