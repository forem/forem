...
RSpec.describe "Broadcasts tasks", type: :task do
  ...
  describe "#broadcast_welcome_notification_flow" do
    xit "does nothing if SiteConfig.welcome_notifications_live_at is nil" do
    ...
    xit "does not call upon users created before the start_date" do
    ...
    xit "call upon users created less than a week ago" do
