...
RSpec.describe "Views an article", type: :system do
  ...
  xit "shows comments", js: true, percy: true do
  ...
  xit "stops a user from moderating an article" do
  ...
  describe "when articles belong to a collection" do
    ...
    context "with regular articles" do
      xit "lists the articles in ascending published_at order" do
    ...
    context "when a crossposted article is between two regular articles" do
      ...
      xit "lists the articles in ascending order considering crossposted_at" do
