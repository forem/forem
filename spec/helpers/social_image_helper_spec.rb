...
describe SocialImageHelper do
  ...
  describe ".user_social_image_url" do
    xit "returns social preview path for newer users" do
      url = helper.user_social_image_url(user)

      expect(url).to eq user_social_preview_url(user, format: :png)
    end

    xit "returns Organization social preview path for Orgs" do
    ...
    xit "returns older url2png image if already generated" do
    ...
    xit "returns social preview path for newer decorated users" do
  ...
  describe ".article_social_image_url" do
    ...
    xit "returns social preview path for newer decorated articles" do
