class StoriesController < ApplicationController
  ...
  def handle_organization_index
    ...
    @organization_json_ld = Articles::JsonCreator.organization(@organization)
  ...
  def handle_user_index
    ...
    @user_json_ld = Articles::JsonCreator.new.user(@user)
  ...
  def assign_article_show_variables
    ...
    @article_json_ld = Articles::JsonCreator.new.article(@article, @user)
    assign_co_authors
