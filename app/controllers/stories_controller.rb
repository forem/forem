class StoriesController < ApplicationController
  ...
  def handle_tag_index
    ...
    @stories = Feeds::Optimized.new(number_of_articles: @number_of_articles, tag: @tag, page: @page)
  ...
  def featured_story
    @featured_story ||= Feeds::Optimized.find_featured_story(@stories)
  end
  ...
  def assign_feed_stories
    feed = Feeds::Optimized.new(page: @page, tag: params[:tag])
