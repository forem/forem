class DashboardsController < ApplicationController
  ...
  def show
    ...
    Articles::AnalyticsUpdaterJob.perform_later(current_user.id) if @articles && ApplicationConfig["GA_FETCH_RATE"] < 50 # Rate limit concerned, sometimes we throttle down.
  end
