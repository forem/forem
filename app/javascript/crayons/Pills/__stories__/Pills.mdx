...
This constraint should limit overusing it for undesigneted scenarios.
...
For that reason, if you need such a pill toggling a prop `iconRightDestructive` will set "x" icon as default for right icon
