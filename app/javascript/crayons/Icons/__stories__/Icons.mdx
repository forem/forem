<mark>Please disregard generated HTML output in one of the tabs in the panel below. This one is a special snowflake for which you should use rails helper instead.</mark>
...
Keep in mind there's no need to provide the folder path - helper handles that.
