...
CTA is meant to be more prominent and viusally heavy so use these cautiously.
...
Icon-only CTAs should always use clear and obvious icon, ideally accompanied by a title.
