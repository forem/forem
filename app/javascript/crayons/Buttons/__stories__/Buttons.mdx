...
The _Primary_ variant has special look: high contrast (against rest of the view/component) and it's filled with accent color. 
...
The _Secondary_ variant is visually in between _Primary_ and _Default_ buttons. It's not as loud as _Primary_ button but definitely stands out more than _Default_ button.
