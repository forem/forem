  ...
  <div className="crayons-story__comments">
    ...
    <div className="crayons-comment pl-2">
      ...
      <div className="crayons-comment__body">
        ...
        good visual rythm between elements. Medium should be used to emphasize
        something but not make it as loud as Bold.
      </div>
    </div>
    ...
    <div className="crayons-story__comments__actions">
      <a
        href="/"
        className="crayons-btn crayons-btn--secondary crayons-btn--s mr-2"
      >
        See all 7 comments
      </a>
      <button
