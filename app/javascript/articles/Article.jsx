      ...
      >
        ...
        <div className={`crayons-story__body crayons-story__body-${article.type_of}`}>
          ...
          <div className="crayons-story__indention">
            ...
            {article.type_of === 'status' && article.body_preview && article.body_preview.length > 0 && (<div className='text-styles' dangerouslySetInnerHTML={{__html: article.body_preview}} />)}
