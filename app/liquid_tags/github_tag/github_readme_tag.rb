class GithubTag
  class GithubReadmeTag
    ...
    def render
      content = Github::Client.new.repository(repository_path)
    ...
    def fetch_readme(repository_path)
      readme_html = Github::Client.new.readme(repository_path, accept: "application/vnd.github.html")
      readme = Github::Client.new.readme(repository_path)
