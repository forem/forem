article_attributes_to_include = %i[
  title path id user_id comments_count public_reactions_count organization_id image_list description description_html processed_html quick_share processed_preview_link nsfw
