class RateLimitChecker
  ...
  CONFIGURABLE_RATES = {
    rate_limit_follow_count_daily: { min: 0, placeholder: 500, description: "Used to limit the amount of users a person can follow daily" },
    rate_limit_comment_creation: { min: 0, placeholder: 9, description: "Used to limit the amount of comments a user can create within 30 seconds" },
    rate_limit_published_article_creation: { min: 0, placeholder: 9, description: "Used to limit the amount of articles a user can create within 30 seconds" },
    rate_limit_image_upload: { min: 0, placeholder: 9, description: "Used to limit the amount of images a user can upload within 30 seconds" },
    rate_limit_email_recipient: { min: 0, placeholder: 5, description: "Used to limit the amount of emails we send to a user within 2 minutes" },
    rate_limit_organization_creation: { min: 1, placeholder: 1, description: "Number of organizations a user can create within a 5 minute period" }
  }.freeze
