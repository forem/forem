class FeedConfig < ApplicationRecord
  ...
  def score_sql(user)
    ...
    user_follow_ids = activity_store.alltime_users.first(200) + (activity_store&.recent_users&.compact || [])
    organization_follow_ids = activity_store.alltime_organizations.first(200) + (activity_store&.recent_organizations&.compact || [])
