...
class SiteConfig < RailsSettings::Base
  ...
  field :facebook_key, type: :string, default: ApplicationConfig["FACEBOOK_APP_ID"]
  field :facebook_secret, type: :string, default: ApplicationConfig["FACEBOOK_APP_SECRET"]
