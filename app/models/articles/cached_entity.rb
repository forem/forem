module Articles
  ...
  CachedEntity = Struct.new(:name, :username, :slug, :profile_image_90, :profile_image_url,
                            :cached_base_subscriber?, :cached_community_leader?) do
    ...
    def self.from_object(object)
      new(
        ...
        object.cached_community_leader?,
      )
    end
  end
end
