class User < ApplicationRecord
  ...
  has_many :subscription_sources, foreign_key: :author_id, inverse_of: :author, dependent: :destroy
  has_many :subscribers, through: :subscription_sources, dependent: :destroy
