class User < ApplicationRecord
  ...
  attr_accessor :scholar_email, :new_note, :ban_from_mentorship, :quick_match, :mentorship_note, :note_for_current_role, :add_mentor, :add_mentee, :user_status, :toggle_mentorship
