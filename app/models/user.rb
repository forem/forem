class User < ApplicationRecord
  ...
  has_many :email_subscriptions, foreign_key: :author_id, inverse_of: :author, dependent: :destroy
  has_many :subscribers, through: :email_subscriptions, dependent: :destroy
