...
class Tag < ActsAsTaggableOn::Tag
  ...
  def evaluate_markdown
    self.rules_html = MarkdownProcessor::Parse.new(rules_markdown).evaluate_markdown
    self.wiki_body_html = MarkdownProcessor::Parse.new(wiki_body_markdown).evaluate_markdown
  end
