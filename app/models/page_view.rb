class PageView < ApplicationRecord
  ...
  def record_field_test_event
    ...
    Users::RecordFieldTestEventWorker.perform_async(user_id, :follow_implicit_points, "user_views_article_four_days_in_week")
    Users::RecordFieldTestEventWorker.perform_async(user_id, :follow_implicit_points, "user_views_article_four_hours_in_day")
  end
end
