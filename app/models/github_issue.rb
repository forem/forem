...
class GithubIssue < ApplicationRecord
  ...
  PATH_COMMENT_REGEXP = /\/issues\/comments\//.freeze
  PATH_ISSUE_REGEXP = /\/issues\//.freeze
  PATH_PULL_REQUEST_REGEXP = /\/pulls\//.freeze
  PATH_REPO_REGEXP = /.*github\.com\/repos\//.freeze
