...
gem "recaptcha", "~> 5.21", require: "recaptcha/rails" # Helpers for the reCAPTCHA API
...
gem "terser", "~> 1.2" # Terser is a Ruby wrapper for the terser JavaScript parser and minifier
