...
gem "aws-sdk-lambda", "~> 1.31" # Official AWS Ruby gem for AWS Lambda
...
gem "redis-session-store", "~> 0.11.1" # A drop-in replacement for e.g. MemCacheStore to store Rails sessions (and Rails sessions only) in Redis.
