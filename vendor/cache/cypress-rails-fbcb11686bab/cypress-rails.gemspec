...
Gem::Specification.new do |s|
  ...
  s.files = [".github/workflows/main.yml".freeze, ".gitignore".freeze, ".standard.yml".freeze, ".travis.yml".freeze, "CHANGELOG.md".freeze, "Gemfile".freeze, "Gemfile.lock".freeze, "LICENSE.txt".freeze, "README.md".freeze, "Rakefile".freeze, "bin/console".freeze, "bin/setup".freeze, "cypress-rails.gemspec".freeze, "exe/cypress-rails".freeze, "lib/cypress-rails.rb".freeze, "lib/cypress-rails/config.rb".freeze, "lib/cypress-rails/env.rb".freeze, "lib/cypress-rails/finds_bin.rb".freeze, "lib/cypress-rails/init.rb".freeze, "lib/cypress-rails/initializer_hooks.rb".freeze, "lib/cypress-rails/launches_cypress.rb".freeze, "lib/cypress-rails/manages_transactions.rb".freeze, "lib/cypress-rails/open.rb".freeze, "lib/cypress-rails/railtie.rb".freeze, "lib/cypress-rails/rake.rb".freeze, "lib/cypress-rails/resets_state.rb".freeze, "lib/cypress-rails/run.rb".freeze, "lib/cypress-rails/server.rb".freeze, "lib/cypress-rails/server/checker.rb".freeze, "lib/cypress-rails/server/middleware.rb".freeze, "lib/cypress-rails/server/puma.rb".freeze, "lib/cypress-rails/server/timer.rb".freeze, "lib/cypress-rails/starts_rails_server.rb".freeze, "lib/cypress-rails/tracks_resets.rb".freeze, "lib/cypress-rails/version.rb".freeze, "script/test".freeze, "script/test_example_app".freeze]
