...
1.  Setup your database
    1. Create `config/database.yml` by copying from the provided template (i.e. `cp config/database.yml.sample config/database.yml`)
    2. Update the `config/database.yml` file if needed.
