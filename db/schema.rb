...
ActiveRecord::Schema.define(version: 2021_03_31_181505) do
  ...
  create_table "articles", force: :cascade do |t|
    ...
    t.index ["body_markdown"], name: "index_articles_on_body_markdown_trgm", opclass: :gin_trgm_ops, using: :gin
  ...
  create_table "pg_search_documents", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.index "to_tsvector('simple'::regconfig, COALESCE(content, ''::text))", name: "index_pg_search_documents_on_username_as_tsvector", using: :gin
