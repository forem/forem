...
func run(args []string, stdout io.Writer, stderr io.Writer) error {
	flags := flag.NewFlagSet("search-rollback-plan", flag.ContinueOnError)
	...
	payload, err := elastic.RollbackPlanJSON(search.IndexFamily{Prefix: *prefix, Version: *version}, *analyzer)
	if err != nil {
		return err
	}
