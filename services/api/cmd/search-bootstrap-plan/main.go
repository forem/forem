...
func run(args []string, stdout io.Writer, stderr io.Writer) error {
	flags := flag.NewFlagSet("search-bootstrap-plan", flag.ContinueOnError)
	...
	payload, err := elastic.BootstrapPlanJSON(search.IndexFamily{Prefix: *prefix, Version: *version}, *analyzer)
	if err != nil {
		return err
	}
