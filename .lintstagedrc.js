...
module.exports = {
  ...
  '*.rake': ['bundle exec rubocop --autocorrect --enable-pending-cops'],
  '*.scss': ['prettier --write'],
  '*.svg': ['svgo --pretty'],
  '*.{js,jsx}': [
    'prettier --write',
  ...
  './Gemfile': ['bundle exec rubocop --autocorrect --enable-pending-cops'],
  ...
  'app/views/**/*.jbuilder': [
    'bundle exec rubocop --autocorrect --enable-pending-cops',
  ],
