...
Rails.application.routes.draw do
  ...
  # Devise does not support scoping omniauth callbacks under a dynamic segmentn gjdfdghjalk;ldad dsafyjgkhjladgcgdsajkd wdqtyjhkjldahsgjhkl asghjsda sadfhjgkhdljsk;dshadsg fsgdhaj
